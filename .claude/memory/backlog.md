...
### 💾 memory - the-oversized-rental (A5)
...
### 💾 memory - the-span-left-behind (A3)
...
### 💾 memory - the-cache-that-owns-its-keys (A6)
...
### 💾 memory - the-stack-that-only-grows (A6)
